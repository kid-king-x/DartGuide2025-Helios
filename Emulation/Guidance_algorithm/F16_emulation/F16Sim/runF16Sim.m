...
% fi_type是个字符串，后续写入文件的时候会用到，ele_0.000ail_0.000rud_0.000_lofimodel_alt15000_vel500.txt
global altitude fi_type velocity fi_flag_Simulink; 
global surface1 surface2 surface3;
% ElevatorDis AileronDis RudderDis为三个舵面的扰动
...
%% Change these values.
% 这些值就是在pdf文档trim_F16.m这个文件夹说明下的，
% 最好不要修改的初始数值，在这些数值下，仿真收敛的不错
