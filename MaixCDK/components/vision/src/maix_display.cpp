...
#include "maix_image_trans.hpp"
    ...
    #include "maix_display_sdl.hpp"    // Linux平台使用SDL
    #include "maix_display_fb.hpp"    // 帧缓冲支持
#endif
#ifdef PLATFORM_MAIXCAM
    #include "maix_display_mmf.hpp"     // MAIXCAM平台多媒体框架
    #include "maix_display_fb.hpp"
#endif
#ifdef PLATFORM_MAIXCAM2
    #include "maix_display_maixcam2.hpp"    // MAIXCAM2专用实现
    #include "maix_display_fb.hpp"
#endif
...
namespace maix::display
{
    ...
    static ImageTrans *img_trans = nullptr; // 图像传输对象指针
